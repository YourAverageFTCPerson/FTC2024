...
public class MecanumTeleOp extends LinearOpMode {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    Servo bucketServo = hadrwareMap.servo.get("bucketServo");
    ...
    int frontLeftTarget = (-96 * EncoderPositionsPerInch);
    int frontRightTarget = (96 * EncoderPositionsPerInch);
    int backLeftTarget = (96 * EncoderPositionsPerInch);
    int backRightTarget = (-96 * EncoderPositionsPerInch);
